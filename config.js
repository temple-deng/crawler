...
var options = {
  ...
  useTimeFilter: 'yes',      // 是否使用时间过滤发帖时间，'no' 就是不过滤，'yes' 为过滤
  startTime: new Date(2011, 4, 1),     // 使用时间过滤情况下的开始时间， 三个参数分别是年，月，日， 注意 月份是 0-11的，所以5月的话参数为4。
  endTime: new Date(2018, 0, 1),       // 结束时间
  startPage: 1,           // 开始爬取的列表的页码，包含这一页，即最小为1，最大为301
  endPage: 10,            // 结束爬取的列表的页码，包含这一页，即最小为1，最大为301
